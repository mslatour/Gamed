...
Throughout history, education has retained approximately the same underlying model of knowledge transfer since the industrial revolution. There is a fixed teacher-driven curriculum which is based on the notion of establishing universal basics as fundamentals and then systematically moving to a more complicated level by taking incremental steps\cite{Davis2012}. 

%A teacher tells the students about a certain subject and the students listen and perhaps discuss the material. 
With each paradigm shift in information technology, this transferring of knowledge has been improved. Paradigm shifts such as: literacy, the printing press, long-distance communication, radio, television and computers. The latest shift in this paradigm is the advent of the internet. Nowadays, for most students high-speed internet is available. This has resulted in yet another change to the mindset of students and, perhaps more importantly, the skills they need to acquire, usually referred to as \emph{21st century skills}. However, this paradigm shift has not been fully visible in education. Perhaps, it is because high-speed internet and the new corresponding skill-set are not easily applicable in current education. Another possibility is the change in how attention and motivation work. The unprecedented amount of 
information that is readily available to students also requires that students remain focussed. In recent years, there has been a shift towards keeping students motivated and engaged with the course material. This motivation is said to be necessary to keep students focussed as well as to increase learning capacity in these students. According to the \emph{Horizon Report 2012} \cite{Horizon2012} two new technologies are on the rise that address these issues. On the one hand, there is \emph{learning analytics} which has various purposes, including: keeping track of students' progress, bla bla bla, bla bla bla and bla bla bla. On the other hand, there is \emph{gamification}, which is mainly concerned with using game-like structures to drive towards certain behaviour while being both motivating and engaging. 
