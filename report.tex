...
The first model is fitted through least median square error regression, resulting in the following coefficients.
...
\bottomrule
\end{tabular}
\caption{Linear Regression through least median squre error}
\end{table}
