...
{\Large
Robrecht \textsc{Jurriaans} \\
Sander \textsc{Latour} \\[0.5cm]
...
\hline
    &
    \begin{sideways}Monitoring and analysis\end{sideways}& %1
    \begin{sideways}Prediction and intervention\end{sideways}& %2
    \begin{sideways}Tutoring and mentoring\end{sideways}& %3
    \begin{sideways}Assessment and feedback\end{sideways}& %4
    \begin{sideways}Adaption\end{sideways}& %5
    \begin{sideways}Personalization and recommendation\end{sideways}& %6
    \begin{sideways}Reflection\end{sideways}& %7
    \begin{sideways}Learners\end{sideways}& %8
    \begin{sideways}Instructors / Mentors \end{sideways}& %9
    \begin{sideways}Institutions\end{sideways} \\ %A
\hline
%                       & 1 & 2 & 3 & 4 & 5 & 6 & 7 & 8 & 9 & A \\
\cite{Brusilovsky2001}  &   &   &   &   & X & X &   & X &   &   \\ %overview
\cite{Brusilovsky2003}  &   &   &   &   & X & X &   & X &   &   \\ %overview
\cite{Brusilovsky2007}  &   &   &   &   & X & X &   & X &   &   \\ %overview
\cite{Weber2001}        &   &   &   & X & X & X &   & X &   &   \\
\cite{Henze2001}        &   &   &   &   & X & X &   & X &   &   \\
\cite{Farzan2004}       &   &   &   &   &   & X &   & X &   &   \\
\cite{Tang2005}         &   &   &   &   &   & X &   & X &   &   \\
\cite{Reategui2008}     &   &   &   &   & X & X &   & X &   &   \\
\cite{Modritscher2011}  &   &   &   &   &   & X &   & X &   &   \\ % overview
\cite{Mazza2004}        & X &   &   &   &   &   &   &   & X &   \\
\cite{Shum2012}         & X &   & X &   &   &   & X & X &   &   \\
\cite{Ullmann2011}      & X &   & X &   &   &   & X & X & X &   \\
\cite{Haiming2012}      &   &   & X &   &   &   & X & X & X &   \\
\cite{Fournier2011}     & X &   &   &   &   &   & X & X & X &   \\
\cite{Ferguson2012b}    & X &   & X &   &   &   &   & X & X &   \\ %overview
...
\pagebreak
\appendix
\section{Further Possibilities}\label{furtherposs}
