...
\begin{tabular}{ll}
Gender & Frequency \\ \hline
Male & 83 \\
Female & 41
\end{tabular}

\begin{tabular}{ll}
General start motivation & Frequency \\ \hline
...
\begin{tabular}{lll}
Game Context element & Frequency (present) & Frequence (not present) \\ \hline
...
Linear Regression Model through Least Median Square error regression
\begin{align}
 motivation  & = \nonumber \\
     -0.0679 & * multi\_ass + \nonumber \\
     -0.0283 & * strict\_dead + \nonumber \\
...
% Notes:
% Badges have highest negative impact
% Expected bonus content to have a positive impact, but apparently it does not
% 


% Expert Review might have been misinterpreted as being more work if assignments are peer-reviewed
...
Linear Regression Model with Aikake measure for feature selection
\begin{align}
 motivation &=  \nonumber \\
     -0.1332 &* badges + \nonumber \\
      0.2163 &* graded + \nonumber \\
      0.2852 &* expert_review + \nonumber \\
      0.1733 &\nonumber \\
\end{align}
